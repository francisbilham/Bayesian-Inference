    ...
    class Program1
    {
        static void Main(string[] args)
        {
            ...
            void Run()
            {
                ...
                double prior_prob_of_pair_related = 0.05;
                double transfer_related_factor = 0.8;
                ...
                Variable<int> Root135 = Variable.New<int>().Named("Root135");
                ...
                Variable<bool> Relationship15 = Variable.New<bool>().Named("Relationship15");
                Variable<bool> Relationship35 = Variable.New<bool>().Named("Relationship35");
                ...
                Variable<bool> Panui15 = Variable.New<bool>().Named("Panui15");
                Variable<bool> Panui35 = Variable.New<bool>().Named("Panui35");

                using (Variable.If(Root123 == 0))
                {
                    Root124.SetTo(Variable.Discrete(probs_first_pair_set_0));
                    Root135.SetTo(Variable.Discrete(probs_first_pair_set_0));
                ...
                {
                    Root124.SetTo(Variable.Discrete(probs_first_pair_set_0));
                    Root135.SetTo(Variable.Discrete(probs_first_pair_set_1));
                    Relationship23.SetTo(Variable.Bernoulli(0));
                }
                ...
                using (Variable.If(Root135 == 0))
                {
                    Relationship13.SetTo(Variable.Bernoulli(0));
                    Relationship15.SetTo(Variable.Bernoulli(0));
                    Relationship35.SetTo(Variable.Bernoulli(0));
                }

                using (Variable.If(Root135 == 1))
                {
                ...
                using (Variable.If(Root135 == 2))
                {
                    Relationship13.SetTo(Variable.Bernoulli(0));
                    Relationship15.SetTo(Variable.Bernoulli(1));
                    Relationship35.SetTo(Variable.Bernoulli(0));
                }

                using (Variable.If(Root135 == 3))
                {
                    Relationship13.SetTo(Variable.Bernoulli(0));
                    Relationship15.SetTo(Variable.Bernoulli(0));
                    Relationship35.SetTo(Variable.Bernoulli(1));
                }

                using (Variable.If(Root135 == 4))
                {
                    Relationship13.SetTo(Variable.Bernoulli(1));
                    Relationship15.SetTo(Variable.Bernoulli(1));
                    Relationship35.SetTo(Variable.Bernoulli(0));
                ...
                using (Variable.If(Relationship15))
                {
                    Panui15.SetTo(Variable.Bernoulli(0.7));
                }

                using (Variable.IfNot(Relationship15))
                {
                    Panui15.SetTo(Variable.Bernoulli(0.005));
                }

                using (Variable.If(Relationship35))
                {
                    Panui35.SetTo(Variable.Bernoulli(0.7));
                }

                using (Variable.IfNot(Relationship35))
                {
                    Panui35.SetTo(Variable.Bernoulli(0.005));
                }
                ...
                Panui15.ObservedValue = true;
                Panui35.ObservedValue = true;
                ...
                Console.Write("15: ");
                Console.WriteLine(ie.Infer(Relationship15));
                Console.Write("35: ");
                Console.WriteLine(ie.Infer(Relationship35));
